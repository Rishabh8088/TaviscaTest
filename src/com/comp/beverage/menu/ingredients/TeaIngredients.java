...
public class TeaIngredients {

	public float finalPrice = 4.0f;

	public void teaIngredient() {
		...
		List<String> ingredientList = new ArrayList<String>(
				Arrays.asList("Tea Leef", "Milk", "Sugar", "Water", "Confirm Order?"));
	...
	private static final int TEA_LEEF = 1;
